package com.focusit.log4j.udpbroadcast.util;
...
public class CompactObjectInputStream extends ObjectInputStream {
	...
	protected ObjectStreamClass readClassDescriptor()
		...
		switch (type) {
			case com.focusit.log4j.udpbroadcast.util.CompactObjectOutputStream.TYPE_FAT_DESCRIPTOR:
				return super.readClassDescriptor();
			case com.focusit.log4j.udpbroadcast.util.CompactObjectOutputStream.TYPE_THIN_DESCRIPTOR:
